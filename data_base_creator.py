...
try:
    ...
    if conn.is_connected():
        ...
        cursor.execute(
            "CREATE TABLE dry_air (temperatura INT(3), gestosc FLOAT(4,3), cieplo_wlasciwe FLOAT(4,3), wspl_przew_ciepla FLOAT(3,2), wspl_dyf_cieplnej FLOAT(4,1), wspl_lepkosci_dynamicznej FLOAT(3,1), wspl_lepkosci_kinematycznej FLOAT(6,2), liczba_prandtla FLOAT(4,3))")
